...
export const dict = {
    ru: {
        ...
        Email: "Повторите свой адрес эл. почты",
        ...
        "An account with the given email already exists.":
            ...
            "Password did not conform with policy: Password must have uppercase characters": "Пароль должен включать не менее одной заглавной буквы",
            "Password did not conform with policy: Password not long enough": "Пароль должен состоять из не менее чем 8 знаков",
            "Password did not conform with policy: Password must have numeric characters": "Пароль должен содержать цифры",
            "Password did not conform with policy: Password must have symbol characters": "Пароль не соответствует политике: пароль должен содержать символы"
    }
}
